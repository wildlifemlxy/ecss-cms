    ...
    async allAccessRights(accountId) 
    {
        try {
            ...
            if(result === "Connected to MongoDB Atlas!")
            {
                ...
                var accessRights = {"Account": connectedDatabase["Account"], "Courses": connectedDatabase["Courses"], "Registration And Payment": connectedDatabase["Registration And Payment"], "QR Code":  connectedDatabase["QR Code"], "Reports":  connectedDatabase["Reports"], "Attendances":  connectedDatabase["Attendances"]}
                return accessRights;
            }
        } 
        catch (error) 
