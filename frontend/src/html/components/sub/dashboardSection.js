...
class DashboardSection extends Component {
    ...
    fetchCourseReportVisualization = async () => {
        try {
            ...
            const response = await axios.post('https://ecss-backend-django-backup.azurewebsites.net/course_report/');
    ...
    fetchSalesReportVisualization = async () => 
    {
        try 
        {
            ...
            const response = await axios.post('https://ecss-backend-django-backup.azurewebsites.net/sales_report/');
            const data = response.data;
